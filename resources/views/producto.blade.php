...
@section('content')
    <div class="flex flex-col gap-10 max-sm:gap-6 min-h-[80vh]">
            ...
            <div class="w-full md:w-3/4 max-sm:w-full">
                <div class="flex flex-col md:flex-row gap-5 max-sm:gap-4">
                    ...
                    <div class="w-full md:w-1/2 relative max-sm:w-full">
                        ...
                        <div class="flex items-center justify-center h-[410px] max-sm:h-[280px]">
                            @if ($producto->imagenes->first())
                                <img id="mainImage" src="{{ $producto->imagenes->first()->image }}"
                                    alt="{{ $producto->titulo }}"
                                    class="w-full h-full object-cover object-center transition-opacity duration-300 ease-in-out rounded-lg">
                            @else
                                <div
                        ...
                        <!-- Thumbnails -->
                        <div
                            class="absolute -bottom-24 mt-5 flex lg:justify-start justify-center gap-2 overflow-x-auto max-sm:static max-sm:mt-4 max-sm:justify-start max-sm:gap-1.5 rounded-lg">
                    ...
                    <div class="w-full md:w-1/2 flex flex-col min-h-full justify-between max-sm:w-full max-sm:mt-6">
                        <div class="flex flex-col gap-3">
                            <div class="flex flex-col">
                                <h3 class="uppercase font-bold text-[14px] text-primary-orange">
                            ...
                            <div class="mb-6 max-sm:mb-4">
                                <div class="border-t border-gray-200">
                                    <div class="flex  border-gray-200 py-3.5 max-sm:py-2.5">
                        ...
                        <a href="{{ route('contacto', ['mensaje' => $producto->name]) }}"
                            class="w-full flex justify-center items-center bg-primary-orange text-white font-bold h-[41px] max-sm:h-[36px] max-sm:text-sm rounded-lg">
                            Consultar
                        </a>
                    </div>
                </div>
