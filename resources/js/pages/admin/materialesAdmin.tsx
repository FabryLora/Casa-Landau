import MaterialesAdminRow from '@/components/materialesAdminRow';
...
export default function MaterialesAdmin() {
    const { materiales } = usePage().props;
    ...
    const handleSubmit = (e) => {
        ...
        post(route('admin.materiales.store'), {
            preserveScroll: true,
            onSuccess: () => {
        ...
        <Dashboard>
            <div className="flex w-full flex-col p-6">
                        ...
                        >
                            <form onSubmit={handleSubmit} method="POST" className="text-black">
                                <div className="w-[500px] rounded-md bg-white p-4">
                                    <h2 className="mb-4 text-2xl font-semibold">Crear Material</h2>
                ...
                <div className="mx-auto flex w-full flex-col gap-3">
                    <h2 className="border-primary-orange text-primary-orange text-bold w-full border-b-2 text-2xl">Materiales</h2>
                    ...
                    <div className="flex w-full justify-center">
                        <table className="w-full border text-left text-sm text-gray-500 rtl:text-right dark:text-gray-400">
                            ...
                            <tbody className="text-center">
                                {materiales.data?.map((material) => <MaterialesAdminRow key={material.id} material={material} />)}
                            </tbody>
                        </table>
                    </div>
                            ...
                            <div className="flex items-center">
                                {materiales.links.map((link, index) => (
                                    <button
                                        ...
                                        } ${index === 0 ? 'rounded-l-md' : ''} ${index === materiales.links.length - 1 ? 'rounded-r-md' : ''}`}
                    ...
                    <div className="mt-2 text-center text-sm text-gray-600">
                        Mostrando {materiales.from || 0} a {materiales.to || 0} de {materiales.total} resultados
                    </div>
                </div>
            </div>
        </Dashboard>
