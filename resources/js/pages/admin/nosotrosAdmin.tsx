...
export default function NosotrosAdmin() {
    ...
    return (
        <Dashboard>
            <form onSubmit={handleSubmit} className="flex flex-col gap-10 p-6">
                ...
                <h2 className="border-primary-orange text-primary-orange text-bold w-full border-b-2 text-2xl">Video</h2>
